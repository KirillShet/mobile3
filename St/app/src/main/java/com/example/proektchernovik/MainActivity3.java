package com.example.proektchernovik;
...
import com.example.proektchernovik.models.User;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String passwordTwo = name3Text.getText().toString();
            ...
            {
                User user = new User(email, password, name, passwordTwo);
